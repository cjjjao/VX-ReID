...
def process_query_RX01(data_path, mode='all', relabel=False):
    data_path = '../Datasets/RX2_07/query/'#'/data/cja/cja_proj/Datasets/RX2_07/query/'#'/media/data/cja/cja_proj/Datasets/RX2_07/query/'
    if mode == 'all':
        ir_cameras = ['cam2']
    elif mode == 'indoor':
        ir_cameras = ['cam2']
...
def process_gallery_RX01(data_path, mode='all', trial=0, relabel=False):
    data_path = '../Datasets/RX2_07/gallery/'#'/data/cja/cja_proj/Datasets/RX2_07/gallery/' #'/media/data/cja/cja_proj/Datasets/RX2_07/gallery/'
    random.seed(trial)
    ...
    for id in sorted(ids):
        for cam in rgb_cameras:
            ...
            if os.path.isdir(img_dir):
                ...
                #files_rgb.extend(random.sample(new_files, 4))
    gall_img = []
    gall_id = []
    gall_cam = []
