...
data_path = '../Datasets/RX2_07/train/'
...
id_train = ["%04d" % x for x in range(1,3232)]
...
np.save(data_path + 'train_rgb_resized_img384.npy', train_img)
np.save(data_path + 'train_rgb_resized_label384.npy', train_label)

# ir imges
train_img, train_label = read_imgs(files_ir)
np.save(data_path + 'train_ir_resized_img384.npy', train_img)
np.save(data_path + 'train_ir_resized_label384.npy', train_label)
